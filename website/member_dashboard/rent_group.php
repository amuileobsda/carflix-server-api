                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  ...
                  <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm text-gray-500 font-medium">
                      <a href="rent_group_vehicle.php?rg_id=<?php echo $val['rg_id'];?>&status=<?php echo $val['status'];?>" class="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">차량보기</a>
                      <a href="rent_group_member.php?rg_id=<?php echo $val['rg_id'];?>&status=<?php echo $val['status'];?>" class="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">회원보기</a>
                    </td>
