              ...
              <table class="min-w-full divide-y divide-gray-200 table-auto">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <?php
                    ...
                    foreach($group_info['data'] as $key => $val){
                    $count++;
                  ?>
                  <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm text-gray-500 font-medium">
                      <a href="ceo_group_vehicle.php?cg_id=<?php echo $val['cg_id'];?>&status=<?php echo $val['status'];?>" class="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">차량보기</a>
                      <a href="ceo_group_member.php?cg_id=<?php echo $val['cg_id'];?>&status=<?php echo $val['status'];?>" class="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">회원보기</a>
                    </td>
                  </tr>
