<?php 
    ...
    $status = $_GET['status'];
    $sg_id = $_GET['sg_id'];
    $member_info = small_member_info($con, $sg_id, $status);
    ...
    $group_name = small_group_name($con, $sg_id, $status);
     ...
     {
       $result = member_remove($con, $sg_id, $status, $_POST['removeAction']);
    ...
    <div class="flex-auto ">
      <div class="flex flex-col">
        ...
        <div class="bg-indigo-50 min-h-screen">
          ...
          <!--Table-->
          <div class="p-4 font-bold text-gray-600"><?php echo $group_name['sg_title'] ?> 그룹  회원들</div>
                  ...
                  <tr>
                    ...
                    <form method="post">
                      ...
                      <td class="px-6 py-4 whitespace-nowrap text-left text-sm text-gray-500 font-medium">
                          <a href="small_group_member_vehicle_log.php?sg_id=<?php echo $sg_id;?>&status=<?php echo $status;?>&mb_id=<?php echo $val['mb_id'];?>" class="bg-blue-500 hover:bg-blue-100 text-white font-semibold py-2 px-4 border border-gray-400 rounded shadow">차량로그</a>
                      </td>
