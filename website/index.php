        ...
        <div class="bg-indigo-50 min-h-screen">
          <div class=" mt-8 grid lg:grid-cols-3 sm:grid-cols-2 p-4 gap-5 ">
            ...
            <div class="flex items-center justify-between p-5 bg-white rounded shadow-sm border-solid border-2 border-sky-500">
              <div>
                <div class="text-sm text-gray-400 font-bold">회원수</div>
                <div class="flex items-center pt-1">
                  <div class="text-3xl font-medium font-extrabold text-gray-600 "><?php echo $member_count['cnt']; ?></div>
                </div>
              </div>
            ...
            <div class="flex items-center justify-between p-5 bg-white rounded shadow-sm border-solid border-2 border-sky-500">
              <div>
                <div class="text-sm text-gray-400 font-bold">대표수 </div>
                <div class="flex items-center pt-1">
                  <div class="text-3xl font-medium font-extrabold text-gray-600 "><?php echo $ceo_count['cnt']; ?></div>
                </div>
              </div>
              <div class="text-indigo-500">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div class="flex items-center justify-between p-5 bg-white rounded shadow-sm border-solid border-2 border-sky-500">
              <div>
                <div class="text-sm text-gray-400 font-bold">차량수</div>
                <div class="flex items-center pt-1">
                  <div class="text-3xl font-medium font-extrabold text-gray-600 "><?php echo $car_count['cnt']; ?></div>
                </div>
              </div>
              <div class="text-indigo-500">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div class=" mt-2 grid  lg:grid-cols-3  md:grid-cols-3 p-4 gap-3">
            ...
            <div class="col-span-1 flex flex-col   p-8 bg-white rounded shadow-sm border-solid border-2 border-sky-500">
              <b class="flex flex-row text-gray-500">프리미엄 이용권</b>
            ...
            <div class="col-span-1 flex flex-col   p-8 bg-white rounded shadow-sm border-solid border-2 border-sky-500">
              <b class="flex flex-row text-gray-500">이용률</b>
              <div class="flex items-center pt-1">
                  <div class="text-3xl font-medium font-extrabold text-gray-600 blur-sm">33</div>
            	</div>
            ...
            <div class="col-span-1 flex flex-col   p-8 bg-white rounded shadow-sm border-solid border-2 border-sky-500">
              <b class="flex flex-row text-gray-500">하루 방문자수</b>
              <div class="flex items-center pt-1">
                  <div class="text-3xl font-medium font-extrabold text-gray-600 blur-sm">33</div>
            	</div>
